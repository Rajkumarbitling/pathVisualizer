...
const updateUnvisitedNodeNeighbor = (
  ...
  // if (row < grid[0].length - 1 && col > 0) neighbors.push(grid[row + 1][col - 1]);
  // if (row > 0 && col < grid.length - 1) neighbors.push(grid[row - 1][col + 1]);
  // if (row < grid[0].length - 1 && col < grid[0].length - 1) neighbors.push(grid[row + 1][col + 1]);
